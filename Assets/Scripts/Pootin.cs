...
public class Pootin : MonoBehaviour
{
    public float speed = 5f;
    public float cycleTime = 30f;
    public int score = 300;
    public System.Action<Pootin> killed;
    ...
    private void Start()
    {
        // Transform the viewport to world coordinates so we can set the Pootin's destination points
